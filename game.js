...
const bird = {
    ...
    update: function() {
        // IF THE GAME STATE READY STATE, THE BIRD MUST FLAP SLOWLY
        this.period = state.current == state.getReady ? 10 : 5;
        // WE INCREMENT THE FRAME BY 1, EACH BIRD
...
const pipes = {
    ...
    update: function() {
        ...
        for (let i = 0; i < this.position.length; i++) {
            ...
            // IF PIPES GO BEYOND CANVES, WE DELETE THEM FOR THE ARRAY
            if (p.x + this.w <= 0) {
                this.position.shift();
                score.value += 1;
